...
const contactSchema = z.object({
    ...
    employees: z
        ...
        .min(1, 'Digite, pelo menos, um funcionário.'),
    industry: z.string().min(2, 'Digite um segmente'),
    ...
    budgets: z.string(z.enum(referrals)),
    ...
    return (
        ...
        >
            <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-10">
                    ...
                    >
                        ...
                        <input
                            id="name"
                            className={`block w-full rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.name ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                    ...
                    >
                        ...
                        <input
                            id="mail"
                            className={`block w-full rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.mail ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                    ...
                    >
                        ...
                        <input
                            id="employees"
                            className={`block w-full rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.employees ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                            placeholder="1"
                            type="number"
                            {...register('employees', {
                                valueAsNumber: true,
                    ...
                    >
                        ...
                        <input
                            id="industry"
                            className={`block w-full  rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.industry ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                    ...
                    >
                        ...
                        <input
                            id="time"
                            className={`block w-full rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.time ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                    ...
                    >
                        ...
                        <input
                            ...
                            className={`block w-full  rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.enterpriseServices ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                    ...
                    >
                        ...
                        <input
                            id="deliverables"
                            className={`block w-full  rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.deliverables ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
                            placeholder="Digite seus principais serviços"
                            type="text"
                    ...
                    >
                        ...
                        <textarea
                            id="disclaimer"
                            className={`block w-full  rounded-lg border-[.125rem] border-[transparent] bg-pale-50 p-[.875rem] placeholder:text-pale-600 target:outline-blue-500 focus:outline-blue-500 ${errors.disclaimer ? 'border-red-600 text-red-600' : 'text-pale-600'}`}
            ...
            <div className="flex w-full justify-end border-t border-t-blue-950 border-opacity-[.08] pb-4 pt-6 md:pb-8">
                <button
                    type="submit"
                    className="flex items-center gap-2 rounded-full bg-blue-500 px-5 py-3 text-blue-50"
                >
                    Enviar
                    <svg
                        width="10"
